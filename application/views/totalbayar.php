...
<button name="selesaitrans" type="submit" onclick="return confirm('Yakin Sudah Selesai ?')" class="btn btn-primary pull-right col-md-5" value="kirimbrng" style="height:110px;"><h1>Selesai <span class="glyphicon glyphicon-ok"></span></h1></button>
<?=form_close();?>
