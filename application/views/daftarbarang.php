<div class="container-fluid">
  <div class="row">
    <div class="col-md-12" id="kasirheader"><h5><a href="<?=base_url();?>" class="btn btn-primary btn-lg btn-block"> KASIR </a></h5></div>
  </div>
	<div class="row">
		<div class="col-md-3">
            ...
            <tbody>
              ...
              foreach ($data_barang as $barang) {
                ...
                <tr>
                  ...
                  <th>
                    <a href="<?=base_url('pengaturan/edit_barang/') . $barang->id;?>" class="btn btn-primary btn-xs" onclick="return confirm('Data akan diubah, Anda yakin?')">Ubah</a>
                    <a href="<?=base_url('pengaturan/delete_barang/') . $barang->id;?>" class="btn btn-danger btn-xs" onclick="return confirm('Data akan dihapus, Anda yakin?')">Hapus</a>
                  </th>
                </tr>
                <?php
              }
      ...
      if (@$edit_db!='') {
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            <!-- Text input-->
            <div class="form-group">
              <label class="col-md-4 control-label" for="quantity">Kuantitas</label>
              <div class="col-md-4">
            ...
            <div class="form-group">
                  <div class="col-md-8 col-md-offset-5">
                    ...
                    <button name="editbarang" type="submit" class="btn btn-primary" value="editbrng"> Simpan</button>
                  </div>
                </div>
