...
<div class="col-md-6">
  <div class="form-group">
    <label class="col-md-3 control-label" for="quantity">Kuantitas</label>
    <div class="col-md-3">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-3 control-label" for="subtotal">Subtotal</label>
  <div class="col-md-6">
...
<div class="col-md-6">
  <div class="form-group">
    ...
    <div class="col-md-8">
    <button id="btntambah" name="btntambah" type="submit" class="btn btn-primary" value="tambahtransaksi">Tambah</button>
  </div>
</div>
</div>
</fieldset>
    ...
    foreach ($barang_temp as $key_barang) {
      ...
      <tr>
        ...
        <td>
          ...
          <a href="<?=base_url('transaksi/hapustrans/') . $key_barang->id;?>" class="btn btn-danger btn-xs" onclick="return confirm('Data akan dihapus, anda yakin? ?')">Hapus$</a>
        </td>
      </tr>
      <?php
    } ?>
